...
def sendEmailVerificationRequest(sender="networksecurityalerts@contus.in",receiver="mahesh.s@contus.in", custom_text="Hello, Your OTP is ", subject="Email OTP Verification"):
